...
namespace WebClient.Data
{
    public class FamilyWebService : IFamilyService
    {
        ...
        public FamilyWebService()
        {
            ...
            _families = _fileContext.GetFamilies();
        }


        public async Task<IList<Family>> GetAllFamiliesAsync()
        {
            return await _fileContext.Families.
                Include(f => f.Adults).
        ...
        public async Task RemoveFamilyAsync(int familyId)
        {
            ...
            Family toRemoveLocal = _families.First(f => f.Id == familyId);
            _families.Remove(toRemoveLocal);
        ...
        {
            Family toUpdate = _fileContext.Families.First(f => f.Id == family.Id);
